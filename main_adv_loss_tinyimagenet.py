...
def get_args():
    ...
    parser.add_argument('--log_file_name', type=str, default='tinyimagenet_resnet50_MCFL_BadNets_fedavg', help='The log file name')
    ...
    parser.add_argument('--load_backdoor_model_file', type=str, default='X:\Directory\code\MOON-backdoor\models/tinyimagenet_resnet50/tinyimagenet_resnet50_DBA_backdoor_pretrain(triggerOnly)_190.pth', help='the model to load as global model')
    ...
    if args.wandb:
        wandb.init(
            ...
            name='tinyimagenet' + args.partition + '_' +  args.log_file_name,
            config={
            'epochs': args.epochs,
