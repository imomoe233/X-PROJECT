...
def get_args():
    ...
    parser.add_argument('--log_file_name', type=str, default='MNIST_simple-cnn_backdoor_pretrain(triggerOnly)', help='The log file name')
    ...
    parser.add_argument('--modeldir', type=str, required=False, default="./models/MNIST_simple-cnn/", help='Model save directory path')
