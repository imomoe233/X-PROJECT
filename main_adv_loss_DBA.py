...
def get_args():
    ...
    parser.add_argument('--log_file_name', type=str, default='cifar10_resnet50_MCFL_DBA_fedavg', help='The log file name')
    ...
    parser.add_argument('--load_backdoor_model_file', type=str, default='X:\Directory\code\MOON-backdoor\models\cifar10_resnet50_DBA\cifar10_resnet50_DBA_backdoor_pretrain(triggerOnly)_20.pth', help='the model to load as global model')
...
def local_train_net(nets, args, net_dataidx_map, train_dl=None, test_dl=None, global_model=None, prev_model_pool=None, server_c = None, clients_c = None, round=None, device="cuda:0", backdoor_model=None):
    ...
    for net_id, net in nets.items():
        ...
        backdoor_train_dl, backdoor_test_dl, _, _ = get_dataloader(args.dataset, args.datadir, args.batch_size, args.batch_size, dataidxs, backdoor=True, DBA='yes')
